...
# AWG Manager — listas de enrutamiento

> Conjuntos de reglas listos para [AWG Manager](https://t.me/awgmanager).
> Las listas se generan **automáticamente** a partir de varias fuentes abiertas,
> se deduplican y minimizan: los subdominios se consolidan cuando existe un dominio padre explícito,
> y las CIDR superpuestas se agregan.
> El objetivo del proyecto es evitar que el usuario común tenga que añadir manualmente
> decenas de enlaces: basta con conectar los archivos necesarios y obtener un conjunto estándar
> de redes sociales, mensajería, streaming y servicios de IA.
> Roblox se ha extraído en un archivo separado `roblox.lst`: conéctelo según sea necesario.
> Bungie (Destiny/Marathon): los dominios y CIDR para evitar el error TAPIR en los juegos de Bungie se han extraído en `bungie_notapir.lst`: conéctelos según sea necesario.
> Sony PlayStation Network: los dominios y CIDR para PSN se han extraído en `sonypsn.lst`: conéctelos según sea necesario.
> Blizzard Entertainment: los dominios y CIDR para Battle.net, WoW, Diablo, Overwatch, etc., se han extraído en `blizzard.lst`: conéctelos según sea necesario.
> KinoPub: los dominios y CIDR para KinoPub se han extraído en `kinopub.lst`: conéctelos según sea necesario.

© [amatol](https://t.me/amatol_blog) • [Canal de Telegram](https://t.me/amatol_blog)
...
|------|--------:|----------|
| [domains.lst](domains.lst) | 7414 | Dominios para enrutamiento |
| [cidr.lst](cidr.lst)       | 102 | Subredes IP (CIDR) para enrutamiento |
| [roblox.lst](roblox.lst)   | 15 | Dominios y subredes IP de Roblox |
| [bungie_notapir.lst](bungie_notapir.lst) | 9 | Dominios y subredes IP de Bungie (Destiny/Marathon) |
| [sonypsn.lst](sonypsn.lst) | 13 | Dominios y subredes IP de Sony PlayStation Network |
| [blizzard.lst](blizzard.lst) | 83 | Dominios y subredes IP de Blizzard Entertainment |
| [kinopub.lst](kinopub.lst) | 21 | Dominios y subredes IP de KinoPub |

---

## Fuentes de `domains.lst`

La lista de dominios se compila a partir de las siguientes fuentes:

- [ooni_domains.lst  *(de 1andrevich/Re-filter-lists)*](https://raw.githubusercontent.com/1andrevich/Re-filter-lists/refs/heads/main/ooni_domains.lst)
- [inside-kvas.lst  *(de itdoginfo/allow-domains)*](https://raw.githubusercontent.com/itdoginfo/allow-domains/refs/heads/main/Russia/inside-kvas.lst)
- [community.lst  *(de 1andrevich/Re-filter-lists)*](https://raw.githubusercontent.com/1andrevich/Re-filter-lists/refs/heads/main/community.lst)
- [geoblock.lst  *(de itdoginfo/allow-domains)*](https://raw.githubusercontent.com/itdoginfo/allow-domains/refs/heads/main/Categories/geoblock.lst)
- [telegram_domain  *(de RockBlack-VPN/ip-address)*](https://raw.githubusercontent.com/RockBlack-VPN/ip-address/refs/heads/main/Global/Telegram/telegram_domain)
- [kino.lst  *(de amatol/xkeen-configuration)*](https://raw.githubusercontent.com/amatol/xkeen-configuration/refs/heads/main/rules/kino.lst)
- [community.lst  *(de amatol/xkeen-configuration)*](https://raw.githubusercontent.com/amatol/xkeen-configuration/refs/heads/main/rules/community.lst)
- [discord.lst  *(de itdoginfo/allow-domains)*](https://raw.githubusercontent.com/itdoginfo/allow-domains/refs/heads/main/Services/discord.lst)
- [meta.lst  *(de itdoginfo/allow-domains)*](https://raw.githubusercontent.com/itdoginfo/allow-domains/refs/heads/main/Services/meta.lst)
- [tiktok.lst  *(de itdoginfo/allow-domains)*](https://raw.githubusercontent.com/itdoginfo/allow-domains/refs/heads/main/Services/tiktok.lst)
- [twitter.lst  *(de itdoginfo/allow-domains)*](https://raw.githubusercontent.com/itdoginfo/allow-domains/refs/heads/main/Services/twitter.lst)
- [youtube.lst  *(de itdoginfo/allow-domains)*](https://raw.githubusercontent.com/itdoginfo/allow-domains/refs/heads/main/Services/youtube.lst)

---

## Fuentes de `cidr.lst`

La lista de subredes IP se compila a partir de las siguientes fuentes:

- [telegram.lst  *(de itdoginfo/allow-domains)*](https://raw.githubusercontent.com/itdoginfo/allow-domains/refs/heads/main/Subnets/IPv4/telegram.lst)
- [telegram.bat  *(de RockBlack-VPN/ip-address)*](https://raw.githubusercontent.com/RockBlack-VPN/ip-address/refs/heads/main/Global/Telegram/telegram.bat)
- [Discord.bat  *(de RockBlack-VPN/ip-address)*](https://raw.githubusercontent.com/RockBlack-VPN/ip-address/refs/heads/main/Global/Discord/Discord.bat)
- [discordgg.bat  *(de RockBlack-VPN/ip-address)*](https://raw.githubusercontent.com/RockBlack-VPN/ip-address/refs/heads/main/Global/Discord/discordgg.bat)

---

## Fuentes de `roblox.lst`

Lista de dominios y subredes IP de Roblox:

- [roblox_domain  *(de RockBlack-VPN/ip-address)*](https://raw.githubusercontent.com/RockBlack-VPN/ip-address/refs/heads/main/Global/Roblox/roblox_domain)
- [roblox-ips.lst  *(de amatol/xkeen-configuration)*](https://raw.githubusercontent.com/amatol/xkeen-configuration/refs/heads/main/rules/roblox-ips.lst)

---

## Fuentes de `bungie_notapir.lst`

Lista de dominios y subredes IP para evitar el error TAPIR en los juegos de Bungie (Destiny/Marathon):

- [bungie_notapir.lst  *(de amatol/xkeen-configuration)*](https://raw.githubusercontent.com/amatol/xkeen-configuration/refs/heads/main/rules/bungie_notapir.lst)
- [bungie_notapir_cidr.lst  *(de amatol/xkeen-configuration)*](https://raw.githubusercontent.com/amatol/xkeen-configuration/refs/heads/main/rules/bungie_notapir_cidr.lst)

---

## Fuentes de `sonypsn.lst`

Lista de dominios y subredes IP de Sony PlayStation Network:

- [sonypsn.bat  *(de RockBlack-VPN/ip-address)*](https://raw.githubusercontent.com/RockBlack-VPN/ip-address/refs/heads/main/Global/SonyPlaystationNetwork/sonypsn.bat)

---

## Fuentes de `blizzard.lst`

Lista de dominios y subredes IP de Blizzard Entertainment (Battle.net, WoW, Diablo, Overwatch, etc.):

- [blizzard.list  *(de MetaCubeX/meta-rules-dat)*](https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/refs/heads/meta/geo/geosite/blizzard.list)
- [blizzard.bat  *(de RockBlack-VPN/ip-address)*](https://raw.githubusercontent.com/RockBlack-VPN/ip-address/refs/heads/main/Global/blizzard/blizzard.bat)

---

## Fuentes de `kinopub.lst`

Lista de dominios y subredes IP de KinoPub:

- [kinopub.list  *(de MetaCubeX/meta-rules-dat)*](https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/refs/heads/meta/geo/geosite/kinopub.list)
- [kino.lst  *(de amatol/xkeen-configuration)*](https://raw.githubusercontent.com/amatol/xkeen-configuration/refs/heads/main/rules/kino.lst)
...
Archivos individuales por servicio del repositorio [RockBlack-VPN/ip-address](https://github.com/RockBlack-VPN/ip-address/tree/main/Global), se actualizan automáticamente:

| Servicio | Dominios | CIDR | Última actualización |
|--------|--------:|-----:|----------------------|
...
*Última actualización: 2026-07-14 03:00:22*
